...
export class AddReturnShippingCost1788013000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `ALTER TABLE "order_return_requests" ADD COLUMN IF NOT EXISTS "return_shipping_cost" numeric(14,2) NOT NULL DEFAULT 0`,
        );
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `ALTER TABLE "order_return_requests" DROP COLUMN IF EXISTS "return_shipping_cost"`,
        );
    }
}
