...
@Index('idx_orders_delivery_confirmation_deadline', [
    'fulfillmentStatus',
...
export class Order {
    ...
    @Column({
        ...
        type: 'enum',
        enum: OrderDeliveryConfirmationStatus,
        enumName: 'order_delivery_confirmation_status_enum',
        default: OrderDeliveryConfirmationStatus.PENDING,
    })
    ...
    @Column({
        ...
        type: 'enum',
        enum: OrderDeliveryConfirmationMethod,
        enumName: 'order_delivery_confirmation_method_enum',
        nullable: true,
    })
