...
import { CreateCodOrderDto } from '@/modules/order/presentation/dto/create-cod-order.dto';
import {
    EmptyCartError,
...
describe('OrderCommandService', () => {
    ...
    beforeEach(async () => {
        ...
        const module: TestingModule = await Test.createTestingModule({
            providers: [
                ...
                {
                    provide: SellerOrderAccessService,
                    useValue: mockSellerOrderAccess,
                },
    ...
    describe('createCodOrder', () => {
        ...
        it('should return the existing order when idempotency key is retried with the same payload', async () => {
            ...
            mockOrderRepository.findByIdempotency.mockResolvedValue(
                existingOrder,
            );
            ...
            expect(mockResponseMapper.toResponse).toHaveBeenCalledWith(
                existingOrder,
            );
        ...
        it('should create a confirmed COD order with authoritative product pricing', async () => {
            ...
            expect(mockProductClient.reserve).toHaveBeenCalledWith(
                idempotencyKey,
        ...
        it('should reject an invalid request context before calling dependencies', async () => {
            ...
            expect(
                mockOrderRepository.findByIdempotency,
    ...
    describe('seller orders', () => {
        ...
        it('should list shop-scoped orders without accepting a client shop id', async () => {
            ...
            mockResponseMapper.toSellerListItem.mockReturnValue(
                expected as never,
            );
    ...
    describe('cancelOwnedOrder', () => {
        it('should release inventory and append cancellation history for a confirmed order', async () => {
            ...
            const orderRepository = {
                ...
                save: jest
                    .fn()
                    .mockImplementation(async (value: Order) => value),
            };
            const historyRepository = {
                create: jest
                    .fn()
                    .mockImplementation(
                        (value: Partial<OrderStatusHistory>) => value,
                    ),
            ...
            expect(mockProductClient.release).toHaveBeenCalledWith(
                idempotencyKey,
        ...
        it('should return cancelled order without releasing inventory on a repeated request', async () => {
            ...
            // Act
            const result = await target.cancelOwnedOrder(
                ownerId,
                'order-1',
                {},
            );
