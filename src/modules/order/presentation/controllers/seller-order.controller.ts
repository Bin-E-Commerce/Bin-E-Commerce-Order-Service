...
import { SellerOrderListQueryDto } from '@/modules/order/presentation/dto/seller-order-list-query.dto';
import type {
...
export class SellerOrderController {
    ...
    listReturns(
        ...
        return this.orderReturnService.listForSeller(
    ...
    inspectReturn(
        ...
        return this.orderReturnService.inspect(
            this.sellerOrderAccess.buildCurrentUserFromHeaders(headers),
            returnId,
            dto,
        );
